                                  ...
                                  onPressed: () async {
                                    try {
                                      ...
                                      if (directoryPath != null && context.mounted) {
                                        await context
                                            .read<WorkspaceCubit>()
                                            .openDirectoryTree(directoryPath);
                                      }
                              ...
                              Expanded(
                                child: BlocBuilder<WorkspaceCubit, WorkspaceState>(
                                  builder: (context, state) {
                                    final workspaces =
                                        state is WorkspaceStateWithWorkspaces
                                        ? state.workspaces
                                        : <RecentWorkspace>[];
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        final isSelected =
                                            state is WorkspaceOpened &&
                                            state.workspaceData.workspacePath ==
                                                workspace.path;
                                        return Padding(
                                          ...
                                          child: Material(
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                context
                                                    .read<WorkspaceCubit>()
                                                    .openDirectoryTree(workspace.path);
                                              },
                                              child: Padding(
                                                padding: const EdgeInsets.symmetric(
                                                  horizontal: 12,
